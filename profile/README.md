...
**Senior Systems Engineer · Developer Productivity · AI & Automation**
...
I build tools that eliminate toil, connect systems, and give people leverage: enterprise integrations, developer productivity tooling, and AI/agent systems, plus a handful of projects that exist because they were interesting — games, applied cryptanalysis, research.

16+ years in systems engineering — Atlassian platform work, developer tooling, and enterprise integrations, most recently at Netflix and Coinbase. Based in Sevierville, TN · B.S. Psychology, Virginia Tech. Full work history in the [resume](https://gist.github.com/nitsuah/086f7d1de6a5fd534ac4ccce226ac1d2).
...
| [**auto-apply-plugin**](https://github.com/nitsuah/auto-apply-plugin) | Chrome extension that reads a job posting and fills out the application using your own API key — no server, nothing tracked | [![CI](https://github.com/nitsuah/auto-apply-plugin/actions/workflows/ci.yml/badge.svg)](https://github.com/nitsuah/auto-apply-plugin/actions) |
...
| [**overseer**](https://github.com/nitsuah/overseer) | Points at a GitHub repo, audits its docs, CI, tests, and security, and opens PRs with the fixes · [live](https://ghoverseer.netlify.app/) | [![CI](https://github.com/nitsuah/overseer/actions/workflows/ci.yml/badge.svg)](https://github.com/nitsuah/overseer/actions) |
